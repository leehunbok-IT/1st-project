    ...
    <div class="container">
        ...
        <c:forEach var="lotto" items="${lottoList}">
            <div class="time">
                <h3>${lotto.times}</h3>
                <div>
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num1}.png"> 
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num2}.png">
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num3}.png">
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num4}.png">
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num5}.png">
                    <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.num6}.png">
                    <span class="bonus">&emsp; + 보너스번호</span>
                    &emsp; <img src="${pageContext.request.contextPath}/images/lotto_img/ball_${lotto.bonusNum}.png">
                </div>
            </div>
        </c:forEach>
        </div>
